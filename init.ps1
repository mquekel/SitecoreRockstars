...
Add-HostsEntry "cm.myproject.localhost"
Add-HostsEntry "cd.myproject.localhost"
Add-HostsEntry "id.myproject.localhost"
Add-HostsEntry "www.myproject.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.myproject.localhost"

    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.myproject.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.myproject.localhost"
