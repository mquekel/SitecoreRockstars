...
Invoke-RestMethod "https://cm.myproject.localhost/sitecore/admin/PopulateManagedSchema.aspx?indexes=all" -Headers @{Authorization = "Bearer $token"} -UseBasicParsing | Out-Null
...
Start-Process https://cm.myproject.localhost/sitecore/
Start-Process https://www.myproject.localhost/
